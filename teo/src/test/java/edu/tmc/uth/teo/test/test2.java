...
public class test2 {
	...
	public void testGetDurationBetweenEvents() {
		...
		System.out.println("Duration between event1 and event4:" + querier.getDurationBetweenEvents(event1, event2, new Granularity(Unit.MONTH)) + "\n");
		System.out.println("Duration between event4 and event2:" + querier.getDurationBetweenEvents(event2, event3, new Granularity(Unit.YEAR)) + "\n");
		System.out.println("Duration between event2 and event3:" + querier.getDurationBetweenEvents(event1, event3, new Granularity(Unit.SECOND)) + "\n");
